<?php $this->layout('main_template', ['title' => 'Users']) ?>
                ...
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../app/src/img/demo/avatars/avatar-b.png');
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 15 Charist
                            St, Detroit, MI, 48212, USA
                        </address>
            ...
            <div id="c_2" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="alita gray">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-warning mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-c.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                            <i class="fas fa-mouse-pointer text-muted mr-2"></i>
                            Alita@smartadminwebapp.com</a>
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 134
                            Hamtrammac, Detroit, MI, 48314, USA
                        </address>
                        <div class="d-flex flex-row">
                            <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color: #4680c2">
                                <i class="fab fa-vk"></i>
            ...
            <div id="c_3" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="dr john cook">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-danger mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-e.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                            <i class="fas fa-mouse-pointer text-muted mr-2"></i>
                            john.cook@smartadminwebapp.com</a>
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 55 Smyth Rd,
                            Detroit, MI, 48341, USA
                        </address>
                        <div class="d-flex flex-row">
                            <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color: #4680c2">
                                <i class="fab fa-vk"></i>
            ...
            <div id="c_4" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="jim ketty">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-k.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                            <i class="fas fa-mouse-pointer text-muted mr-2"></i>
                            jim.ketty@smartadminwebapp.com</a>
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 134 Tasy Rd,
            ...
            <div id="c_5" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="aaron tellus">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-g.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 134 Gallery
                            St, Detroit, MI, 46214, USA
                        </address>
                        <div class="d-flex flex-row">
                            <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color: #4680c2">
                                <i class="fab fa-vk"></i>
            ...
            <div id="c_6" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="sarah mcbrook">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-h.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 13 Jamie Rd,
                            Detroit, MI, 48313, USA
                        </address>
                        <div class="d-flex flex-row">
                            <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color: #4680c2">
                                <i class="fab fa-vk"></i>
            ...
            <div id="c_7" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="jimmy fellan">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-i.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
            ...
            <div id="c_8" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="arica grace">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                        <span class="status status-success mr-3">
                            <span class="rounded-circle profile-image d-block" style="
										background-image: url('../src/img/demo/avatars/avatar-j.png');
										background-size: cover;
									"></span>
                        </span>
                        <div class="info-card-text flex-1">
                ...
                <div class="card-body p-0 collapse show">
                    <div class="p-3">
                        ...
                        <address class="fs-sm fw-400 mt-4 text-muted">
                            <i class="fas fa-map-pin mr-2"></i> 798 Smyth
                            Rd, Detroit, MI, 48341, USA
                        </address>
                        <div class="d-flex flex-row">
                            <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color: #4680c2">
                                <i class="fab fa-vk"></i>
